...
export const register = (req,res)=> {
    ...
    db.query(q,[req.body.email, req.body.username], (err,data)=>{
        ...
        if(data.length) return res.status(409).json("Utilisateur déjà existant.");

        // Créer l'utilisateur et hasher le mot de passe :
...
export const login = (req,res)=> {
    ...
    db.query(q,[req.body.username], (err,data)=> {
        ...
        if(!isPasswordCorrect) return res.status(400).json("Nom d'utilisateur ou Mot de passe incorrect !");
